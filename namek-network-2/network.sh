...
function createOrgs() {
  ...
  infoln "Generate CCP files for Producer, Manufacturer, Deliverer and Retailer"
...
## call the script to join create the channel and join the peers of producer and manufacturer
...
function networkDown() {
  # stop org3 containers also in addition to producer and manufacturer, in case we were running sample to add org3
