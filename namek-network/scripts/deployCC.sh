...
infoln "Installing chaincode on peer0.deliverer..."
installChaincode deliverer
...
checkCommitReadiness producer "\"ProducerMSP\": true" "\"ManufacturerMSP\": false" "\"DelivererMSP\": false" "\"RetailerMSP\": false"
checkCommitReadiness manufacturer "\"ProducerMSP\": true" "\"ManufacturerMSP\": false" "\"DelivererMSP\": false" "\"RetailerMSP\": false"
checkCommitReadiness deliverer "\"ProducerMSP\": true" "\"ManufacturerMSP\": flase" "\"DelivererMSP\": false" "\"RetailerMSP\": false"
 checkCommitReadiness retailer "\"ProducerMSP\": true" "\"ManufacturerMSP\": false" "\"DelivererMSP\": false" "\"RetailerMSP\": false"
## now approve also for org2
approveForMyOrg manufacturer
approveForMyOrg deliverer
approveForMyOrg retailer

## check whether the chaincode definition is ready to be committed
## expect them both to have approved
checkCommitReadiness producer "\"ProducerMSP\": true" "\"ManufacturerMSP\": true" "\"DelivererMSP\": true" "\"RetailerMSP\": true"
checkCommitReadiness manufacturer "\"ProducerMSP\": true" "\"ManufacturerMSP\": true" "\"DelivererMSP\": true" "\"RetailerMSP\": true"
checkCommitReadiness deliverer "\"ProducerMSP\": true" "\"ManufacturerMSP\": true" "\"DelivererMSP\": true" "\"RetailerMSP\": true"
checkCommitReadiness retailer "\"ProducerMSP\": true" "\"ManufacturerMSP\": true" "\"DelivererMSP\": true" "\"RetailerMSP\": true"

## now that we know for sure both orgs have approved, commit the definition
commitChaincodeDefinition producer manufacturer deliverer retailer

## query on both orgs to see that the definition committed successfully
queryCommitted producer
queryCommitted manufacturer
queryCommitted deliverer
...
if [ "$CC_INIT_FCN" = "NA" ]; then
  ...
  chaincodeInvokeInit producer manufacturer deliverer retailer
fi
